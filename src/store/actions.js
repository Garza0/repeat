export const actionTypes = {
  ...
  GET_DECKS_BY_IDS_ARR: 'GET_DECKS_BY_IDS_ARR',
  ...
  GET_CARDS_BY_IDS_ARR: 'GET_CARDS_BY_IDS_ARR',
  ...
  GET_USER_DECKS_SUCCESS: 'GET_USER_DECKS_SUCCESS',
  GET_USER_DECKS_FAIL: 'GET_USER_DECKS_FAIL',
};
...
export const actionCreator = {
  ...
  getUserDecks: (data) => ({ type: actionTypes.GET_DECKS_BY_IDS_ARR, data }), //data - decks ids arr
  ...
  getUserCards: (data) => ({ type: actionTypes.GET_CARDS_BY_IDS_ARR, data }), //data - cards ids arr
